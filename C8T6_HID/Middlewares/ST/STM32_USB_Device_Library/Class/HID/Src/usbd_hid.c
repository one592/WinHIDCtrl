...
__ALIGN_BEGIN static uint8_t USBD_HID_CfgFSDesc[USB_HID_CONFIG_DESC_SIZ]  __ALIGN_END =
{
  ...
  USB_HID_CONFIG_DESC_SIZ, /* wTotalLength: 返回的字节数 */
  0x00,
  0x01,         /*bNumInterfaces: 1 个接口*/
  0x01,         /*bConfigurationValue: 配置值 */
  0x00,         /*iConfiguration: 描述字符串描述符的索引配置*/
  0xE0,         /*bmAttributes: 总线供电并支持远程唤醒 */
  0x32,         /*MaxPower 100 mA: 此电流用于检测Vbus*/
